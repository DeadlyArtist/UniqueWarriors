class Snippets {
    ...
    static defaultSnippets = [
        ...
        new Snippet("Accuracy", "rules/Attacks/Attack Resolution*noChildren*addChild=rules/Attacks/Attack Resolution/Natural Rolls And Modifiers"),
        new Snippet("Graze Range", "rules/Attacks/Attack Resolution*noChildren*addChild=rules/Attacks/Attack Resolution/Common Rules"),
        new Snippet("Crit Range", "rules/Attacks/Attack Resolution*noChildren*addChild=rules/Attacks/Attack Resolution/Common Rules"),
